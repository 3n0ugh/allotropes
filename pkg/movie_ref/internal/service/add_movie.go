...
func (m *AddMovie) Route() application.Route {
...
func (m *AddMovie) endpoint() application.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) (any, error) {
		...
		return m.handle(context.TODO(), AddMovieRequest{Movie: movie})
	}
}

func (m *AddMovie) handle(_ context.Context, r AddMovieRequest) (*AddMovieResponse, error) {
...
func (m *AddMovie) repo(movie domain.Movie) error {
